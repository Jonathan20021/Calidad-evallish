                ...
                <div class="flex items-center space-x-4">
                    ...
                    <form method="GET" action="" class="relative">
                        <input type="text" name="search" value="<?php echo htmlspecialchars($search ?? ''); ?>"
                            ...
                            class="pl-10 pr-4 py-2 border border-gray-300 rounded-lg shadow-sm focus:outline-none focus:ring-indigo-500 focus:border-indigo-500 text-sm w-64">
                        ...
                        <div class="ml-3">
                            <p class="text-sm font-medium text-green-800">
                                ...
                                if ($_GET['success'] === 'deleted')
                                    echo "El formulario ha sido eliminado correctamente.";
                                else
                    ...
                    <div class="flex">
                        ...
                        <div class="ml-3">
                            <p class="text-sm font-medium text-amber-800">
                                <?php
                                if ($_GET['warning'] === 'has_evaluations')
                                    echo "El formulario no se puede eliminar porque ya tiene evaluaciones asociadas. Ha sido marcado como <strong>inactivo</strong> para conservar el historial.";
                                else
                                    echo "Atención: " . htmlspecialchars($_GET['warning']);
                                ?>
                            </p>
                        </div>
                    </div>
