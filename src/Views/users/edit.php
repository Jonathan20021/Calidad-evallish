        ...
        <div class="max-w-3xl mx-auto py-8 px-4 sm:px-6 lg:px-8">
            <div class="bg-white shadow-sm rounded-xl border border-gray-200 overflow-hidden">
                <div class="px-6 py-5 border-b border-gray-200 bg-gray-50">
                    ...
                    <p class="mt-1 text-sm text-gray-500">Actualiza los datos del usuario seleccionado.</p>
                </div>

                <form action="<?php echo \App\Config\Config::BASE_URL; ?>users/update" method="POST"
                    class="p-8 space-y-6">
                    ...
                    <div class="grid grid-cols-1 gap-y-6 gap-x-4 sm:grid-cols-6">
                            ...
                            <select id="client_id" name="client_id"
                                ...
                                <?php foreach ($clients as $client): ?>
                                    <option value="<?php echo $client['id']; ?>"
                                        <?php echo (int) $user['client_id'] === (int) $client['id'] ? 'selected' : ''; ?>>
                        ...
                        <div class="sm:col-span-6">
                            <label for="password" class="block text-sm font-medium text-gray-700">Nueva Contrasena (opcional)</label>
                        ...
                        <div class="sm:col-span-6">
                            <label class="inline-flex items-center">
                                <input type="checkbox" name="active" <?php echo (int) $user['active'] === 1 ? 'checked' : ''; ?>
