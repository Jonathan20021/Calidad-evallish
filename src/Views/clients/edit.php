    ...
    <main class="flex-1 overflow-x-hidden overflow-y-auto bg-gray-50">
        <header class="bg-white border-b border-gray-200">
            <div class="max-w-6xl mx-auto py-6 px-4 sm:px-6 lg:px-8">
                <h1 class="text-2xl font-bold text-gray-900">Editar cliente corporativo</h1>
                <p class="mt-1 text-sm text-gray-500">Actualiza accesos y configuracion del portal.</p>
            </div>
        </header>
        ...
        <div class="max-w-6xl mx-auto py-8 px-4 sm:px-6 lg:px-8 space-y-6">
            ...
            <form action="<?php echo \App\Config\Config::BASE_URL; ?>clients/update" method="POST" class="space-y-6">
                ...
                <div class="bg-white border border-gray-200 rounded-xl shadow-sm p-6">
                    ...
                    <div class="mt-4 grid grid-cols-1 md:grid-cols-2 gap-4">
                        ...
                        <div>
                            ...
                            <input type="text" name="contact_name" value="<?php echo htmlspecialchars($client['contact_name'] ?? ''); ?>"
                                class="mt-1 w-full rounded-lg border border-gray-300 px-4 py-2.5 focus:ring-2 focus:ring-indigo-500">
                        </div>
                        <div>
                    ...
                    <div class="mt-4">
                        <label class="inline-flex items-center gap-2 text-sm text-gray-700">
                            <input type="checkbox" name="active" <?php echo $client['active'] ? 'checked' : ''; ?>
                ...
                <div class="bg-white border border-gray-200 rounded-xl shadow-sm p-6">
                    ...
                    <div class="mt-4 grid grid-cols-1 md:grid-cols-3 gap-4">
                        <div>
                            ...
                            <input type="text" name="username" value="<?php echo htmlspecialchars($portalUser['username'] ?? ''); ?>" required
                                class="mt-1 w-full rounded-lg border border-gray-300 px-4 py-2.5 focus:ring-2 focus:ring-indigo-500">
                        </div>
                        <div>
                            <label class="text-sm font-medium text-gray-700">Nombre completo</label>
                            <input type="text" name="user_full_name" value="<?php echo htmlspecialchars($portalUser['full_name'] ?? ''); ?>" required
                                class="mt-1 w-full rounded-lg border border-gray-300 px-4 py-2.5 focus:ring-2 focus:ring-indigo-500">
                        </div>
                        <div>
                            <label class="text-sm font-medium text-gray-700">Nueva contrasena (opcional)</label>
                    ...
                    <div class="mt-4">
                        <label class="inline-flex items-center gap-2 text-sm text-gray-700">
                            <input type="checkbox" name="user_active" <?php echo ($portalUser['active'] ?? 1) ? 'checked' : ''; ?>
                                class="rounded border-gray-300 text-indigo-600 focus:ring-indigo-500">
                            Usuario activo
                        </label>
                    </div>
                ...
                <div class="flex justify-end gap-3">
                    ...
                    <button type="submit"
                        class="px-5 py-2.5 rounded-lg bg-indigo-600 text-white font-semibold hover:bg-indigo-700">Guardar cambios</button>
                </div>
            </form>
        </div>
    </main>
