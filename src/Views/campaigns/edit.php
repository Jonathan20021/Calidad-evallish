        ...
        <div class="max-w-3xl mx-auto py-12 px-4 sm:px-6 lg:px-8">
            <div class="bg-white shadow-2xl rounded-2xl overflow-hidden">
                <div class="px-6 py-8 border-b border-gray-100 bg-gray-50">
                    ...
                    <p class="mt-1 text-sm text-gray-500">Modifique los detalles de la campaña.</p>
                </div>
                <form action="<?php echo \App\Config\Config::BASE_URL; ?>campaigns/update" method="POST"
                    class="p-8 space-y-6">
                    ...
                    <div>
                        ...
                        <textarea name="description" id="description" rows="3"
                            class="mt-1 block w-full border border-gray-300 rounded-md shadow-sm py-3 px-4 focus:ring-indigo-500 focus:border-indigo-500 sm:text-sm"><?php echo htmlspecialchars($campaign['description']); ?></textarea>
                    </div>

                    <div class="flex items-center">
                        <input type="checkbox" name="active" id="active" <?php echo $campaign['active'] ? 'checked' : ''; ?> class="h-4 w-4 text-indigo-600 focus:ring-indigo-500 border-gray-300 rounded">
