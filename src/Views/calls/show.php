            ...
            <div class="bg-white shadow-xl rounded-2xl overflow-hidden mb-8">
                <div class="px-8 py-6 border-b border-gray-100 bg-gray-50 flex justify-between items-center">
                    <div>
                        ...
                        <span
                            ...
                            <?php echo $call['status'] === 'pending' ? 'Pendiente de Evaluaci贸n' : 'Evaluada'; ?>
                        </span>
                    </div>
                ...
                <div class="p-8">
                    <div class="bg-gray-900 rounded-xl p-6 mb-8 text-white shadow-inner">
                        ...
                        <?php else: ?>
                            <div class="text-sm text-gray-300">Sin grabaci贸n disponible.</div>
                        <?php endif; ?>
                    </div>

                    <div class="grid grid-cols-1 md:grid-cols-2 gap-8">
                        <div>
                            <h3 class="text-lg font-bold text-gray-900 mb-4 border-b border-gray-100 pb-2">Informaci贸n
                                del Agente</h3>
                            <div class="space-y-3">
                                <div>
                                ...
                                <div>
                                    <span class="text-sm text-gray-500 block">Campa帽a</span>
                                    <span class="font-medium text-gray-900">
                        ...
                        <div>
                            ...
                            <div class="space-y-3">
                                <div>
                                    <span class="text-sm text-gray-500 block">Tel茅fono</span>
                                    <span class="font-medium text-gray-900">
                    ...
                    <div class="mt-8 border-t border-gray-100 pt-6">
                        <h3 class="text-lg font-bold text-gray-900 mb-3">Evaluaci贸n</h3>
                        <?php if (!empty($call['evaluation_id'])): ?>
                            <a href="<?php echo \App\Config\Config::BASE_URL; ?>evaluations/show?id=<?php echo $call['evaluation_id']; ?>"
                                class="text-indigo-600 hover:text-indigo-900 font-medium">Ver evaluaci贸n
                                #<?php echo $call['evaluation_id']; ?></a>
                        <?php else: ?>
                            <div class="text-sm text-gray-600 mb-2">Esta llamada a煤n no tiene evaluaci贸n.</div>
                            <a href="<?php echo \App\Config\Config::BASE_URL; ?>evaluations/create?call_id=<?php echo $call['id']; ?>"
                                class="text-indigo-600 hover:text-indigo-900 font-medium">Crear evaluaci贸n</a>
                    <?php endif; ?>
                    </div>
                    ...
                    <div class="mt-8 border-t border-gray-100 pt-6">
                        ...
                        <?php elseif (!empty($aiAnalytics)): ?>
                            ...
                            <div class="mt-4 grid grid-cols-1 md:grid-cols-2 gap-6">
                                ...
                                <div class="bg-white border border-gray-100 rounded-xl p-4">
                                    <div class="text-sm text-gray-500 mb-2">An醠isis</div>
                                    <div class="text-sm text-gray-800">
                                        <span id="ai-analytics-analysis"><?php echo htmlspecialchars($aiAnalytics['analisis'] ?? 'Sin an醠isis disponible.'); ?></span>
                                    </div>
                                </div>
                            </div>
        ...
        button.addEventListener('click', function (e) {
            ...
            fetch(targetUrl, { credentials: 'same-origin' })
                ...
                .then(function (payload) {
                    ...
                    if (analysisEl) analysisEl.textContent = (data.analisis ?? 'Sin an醠isis disponible.');
